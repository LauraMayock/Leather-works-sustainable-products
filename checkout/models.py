...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        delivery cost to be added where applicable
        """
    ...
    def save(self, *args, **hwargs):
        """
        Override the origional save method to set the order
        number if it hasnt been set
        """
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **hwargs):
        """
        Override the origional save method to set the lineitem
